...
const SIKA: Product[] = [
  ...
  },
  {
    ...
    brand: "sika",
    name: "Sika-01 Primer",
    desc: "1K MS-polymér primer pre suchý betón (univerzálny)",
    package_size_kg: 10,
    cost_per_package: 61,
    cost_per_kg: 6.15,
    sell_by: "package",
    role: "primer",
    // Univerzálny — bez compatible_with (kompatibilný so všetkým)
  },
  {
  ...
  // Pôvodný 304W Matt nahrádza 3306W per cenník 2026
  {
    ...
    desc: "Vodou-riediteľný PU mat lak (nahradil 304W Matt) — anti-yellowing",
    ...
    note: "TODO potvrdiť cenu",
    role: "topcoat",
    // Univerzálny PU lak na epoxidové aj polyuretánové hlavné nátery
    compatible_with: [
      "sika-264plus-kg",
      "sika-264-30",
      "sika-2510w-20",
  ...
  },
  {
    ...
    desc: "Transparent PU lak — vysoký lesk, vodou-riediteľný",
    package_size_kg: 10,
  ...
  },
  {
    ...
    desc: "Transparent PU lak — vyššia odolnosť, šmykľavosť volíteľná",
    package_size_kg: 10,
