...
import {
  CapacityControl,
  ActiveToggle,
} from "@/app/agent/team/client-controls";

export const runtime = "edge";
export const dynamic = "force-dynamic";

/**
 * /workload — Admin-only team workload + inactivity overview.
 *
 * Prístupné cez profile menu (klik na email pill v headeri).
 * V dev móde prístupné aj userovi pre testovanie.
 */
    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          ...
          10 = top performer). Auto-assign vyberá usera s najnižším ratiom load/capacity.
        </p>
      </header>
